...
gulp.task('external_scripts', function() {
  return gulp.src([
      ...
      'assets/external_js/CopyShader.js',
      'assets/external_js/BokehShader.js',
      'assets/external_js/EffectComposer.js',
      'assets/external_js/RenderPass.js',
      'assets/external_js/ShaderPass.js',
      'assets/external_js/MaskPass.js',
      'assets/external_js/BokehPass.js',
      'assets/external_js/LuminosityHighPassShader.js',
      'assets/external_js/UnrealBloomPass.js',
      'assets/external_js/SSAOShader.js',
      'assets/external_js/AudioBufferLoader.js',
